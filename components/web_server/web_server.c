...
const char* index_html =
    ...
    "<style>"
    "body { margin: 0; font-family: Arial, sans-serif; background-color: #f0f4f8; color: #333; display: flex; align-items: center; justify-content: center; height: 100vh; }"
    ".sensor-box { background: #fff; padding: 20px; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.1); max-width: 90vw; width: 300px; text-align: center; }"
    "h1 { color: #0077cc; margin-bottom: 20px; }"
    "p { font-size: 18px; margin: 12px 0; }"
    "span { font-weight: bold; }"
    "#pump { padding: 4px 8px; border-radius: 6px; color: #fff; }"
    ...
    "<p>💧 Water pump status: <span id='pump' class='off'>OFF</span></p>"
    "</div>"
    "<script>"
    "setInterval(()=>{"
    ...
    "pump.className = d.pump === 'ON' ? 'on' : 'off';"
    "});"
    "},1000);"
    "</script></body></html>";
